...
public class TAuthor {
	...
	public void delete(int ID) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Fehler beim löschen der Daten in der Autor Tabelle");
		}
	}

	public int save(String Name) {
		String sql = "insert into tblAuthor (txtName) values ('" + Name + "');";
		int PKid = -1;
		try {
			Statement stmt = TDatabase.connection.createStatement();
			...
			JOptionPane.showMessageDialog(null, "Fehler beim speichern der Daten in der Autor Tabelle");
		}
		return PKid;
	}
